...
def parse_args_and_config():
    ...
    parser.add_argument("--sampling_timesteps", type=int, default=20,  #25   ##########changing sampling timesteps
...
#python3 eval_diffusion.py --config /home/eileen/Diffusion/WeatherDiffusion/configs/lol.yml --resume /home/eileen/Diffusion/ckpts/LOL_V2_ddpm.pth.tar
...
def main():
    ...
    train_loader, val_loader = DATASET.get_loaders(parse_patches=False, validation=args.test_set)

    # create model
    print("=> creating denoising-diffusion model with wrapper...")
    join = DenoisingDiffusion(args, config)
    model = DiffusiveRestoration(join, args, config)
